...
const i18n = {
  ...
  ja: {
    ...
    "missing-date-title": "この日付のスナップショットは存在しない",
    "missing-date-body": "次の日付ではスナップショットが公開されなかった:",
    ...
    "action-not-found": "アクションが見つからない",
    "action-no-id": "URLにアクションIDが指定されていない(?id=gov_action1… が必要)",
    "back-link": "← ガバナンスアクション",
    "stat-type-label": "種別",
    ...
    "action-timeline-help": "プロトコルが観測したイベント。アクティブなアクションは終局状態が観測されるまで「提出」のみを表示する。詳細は方法論 §20.3 を参照。",
    "th-tl-event": "イベント",
    "th-tl-date": "日付 (UTC)",
    "th-tl-epoch": "エポック",
