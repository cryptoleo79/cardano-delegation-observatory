...
const i18n = {
  en: {
    ...
    "home-scale-label": "Across the asy.life ecosystem", "home-dreps-head": "Top 30 leaderboard",
    ...
    "h-nav-command": "Command Center", "h-nav-timeline": "Timeline", "h-nav-pulse": "Ecosystem Pulse", "h-nav-insights": "Memory Insights", "h-nav-mmap": "Memory Map", "h-nav-tretl": "Treasury Timeline",
  ...
  ja: {
    ...
    "home-scale-label": "asy.life エコシステム全体", "home-dreps-head": "トップ30 リーダーボード",
    ...
    "h-nav-command": "コマンドセンター", "h-nav-timeline": "タイムライン", "h-nav-pulse": "エコシステム パルス", "h-nav-insights": "メモリ インサイト", "h-nav-mmap": "メモリ マップ", "h-nav-tretl": "トレジャリー タイムライン",
...
var WHATNEXT = {
  "command-center.html": [["timeline.html", "Timeline", "the full history", "タイムライン", "完全な歴史"], ["ecosystem-pulse.html", "Ecosystem Pulse", "what's active now", "エコシステム パルス", "今アクティブなもの"], ["search.html", "Search", "find a project", "検索", "プロジェクトを探す"]],
  ...
  "memory.html": [["verify.html", "Verify it yourself", "check the record", "自分で検証", "記録を確認"], ["ecosystem-pulse.html", "Ecosystem Pulse", "what's active now", "エコシステム パルス", "今アクティブなもの"], ["timeline.html", "Timeline", "watch it evolve", "タイムライン", "歩みを見る"]],
  ...
  "treasury.html": [["treasury-timeline.html", "Treasury Timeline", "actions & withdrawals in order", "トレジャリー タイムライン", "アクションと出金を時系列で"], ["command-center.html", "Command Center", "the operating picture", "コマンドセンター", "オペレーティングピクチャ"], ["timeline.html", "Timeline", "the full history", "タイムライン", "完全な歴史"]],
  "treasury-timeline.html": [["treasury.html", "Treasury", "balance & reserves", "トレジャリー", "残高と準備金"], ["command-center.html", "Command Center", "the operating picture", "コマンドセンター", "オペレーティングピクチャ"], ["timeline.html", "Timeline", "all domains", "タイムライン", "全領域"]],
  "project.html": [["project-history.html?id={id}", "Project History", "this project's trail", "プロジェクト履歴", "このプロジェクトの軌跡"], ["verify.html", "Verify it yourself", "check this record", "自分で検証", "この記録を確認"], ["search.html", "Search", "find related projects", "検索", "関連プロジェクトを探す"]],
