...
| `hf-vanrossem` | 2026-06-18 | Van Rossem hard fork (Protocol v11) | Protocol Version 11 enacted 2026-06-18 ~21:45 UTC; updated the Plutus cost model and added new cryptographic built-ins. First Cardano hard fork ratified entirely through Voltaire on-chain governance (independent DRep, Constitutional Committee, and SPO thresholds). Named in memory of governance contributor Max van Rossem (d. 2026-01-11). | [`gov_action13pzmlsmmktmfareqpl3gzj9nm63ugwvmp3y7urkjhd8rf89tn6msq95mp3f`](https://proposalexaminer.cardanofoundation.org/proposals/gov_action13pzmlsmmktmfareqpl3gzj9nm63ugwvmp3y7urkjhd8rf89tn6msq95mp3f) | [intersectmbo.org van Rossem upgrade](https://intersectmbo.org/news/cardano-upgrade-van-rossem-hard-fork) |
