...
| `gov-summit2026-fail` | 2026-06-01 | Cardano Summit 2026 treasury funding vote falls short | A treasury funding proposal for Cardano Summit 2026 (revised to ~7.8M ADA, down from an original ~14.07M ADA bundle that included an EMURGO-run TOKEN2049 sponsorship) reached ~65% of DRep stake — short of the ~two-thirds threshold required for treasury actions, missing by ~1.46 points. By headcount 135 delegates voted in favour, 61 against, 24 abstaining, and the Constitutional Committee approved. The Summit was cancelled; the separate TOKEN2049 proposal passed. | Treasury withdrawal governance action (Summit 2026) `[action ID to pin]` | [coindesk 2026-06-01](https://www.coindesk.com/markets/2026/06/01/cardano-governance-vote-kills-summit-approves-smaller-token2049-plan) · [theblock.co](https://www.theblock.co/amp/post/403122/cardano-foundation-cancels-2026-summit-after-treasury-funding-vote-falls-just-short) |
| `hf-vanrossem` | 2026-06-16 (submitted; **pending**) | Van Rossem hard fork (Protocol v11) — initiation | `HardForkInitiation` to Protocol Version 11 ("van Rossem") submitted on-chain 2026-06-16; **active — in DRep/SPO/CC voting, awaiting ratification** (expires epoch 644, ~2026-07-18) as of epoch 642 (2026-07-08). Not yet ratified or enacted. Would update the Plutus cost model and add new cryptographic built-ins. Named in memory of governance contributor Max van Rossem (d. 2026-01-11). _[Corrected 2026-07-10: commit `03ba499` erroneously listed this in §2.1 as "enacted 2026-06-18" and cited the dropped naming `InfoAction`; on-chain it is an active, not-yet-ratified `HardForkInitiation`. When it ratifies/enacts, move it to §2.1 with the enacted date.]_ | [`gov_action1lh2x3kj…` HardForkInitiation](https://proposalexaminer.cardanofoundation.org/proposals/gov_action1lh2x3kjucjkggvwu6l3txggkvmrnhs3flpv8j35lvlcan4gax3xsq3cxfjc) | on-chain `governance_actions` (authority A) |
...
| `eco-emurgo-pentad-exit` | ~2026-07 | EMURGO steps down from the Pentad | EMURGO formally notified the other Cardano governing entities that it would step down from its duties as a member of the Pentad (Cardano's founding-entity governance group), stating its immediate priority was the SecondFi recovery process. `[early July 2026 — day-level date to confirm]` | [EMURGO official (X)](https://x.com/emurgo_io/status/2074805401657487562) |
| `eco-secondfi-shutdown` | 2026-07-06 | SecondFi wallet permanent shutdown | EMURGO announced the permanent shutdown of the SecondFi wallet (formerly Yoroi); it will not resume after a June 2026 exploit that left users' private keys derivable from public on-chain data (374 wallets, ~16M ADA affected). Remaining activity limited to asset recovery and user migration. | [forum.cardano.org — official EMURGO recovery update](https://forum.cardano.org/t/secondfi-is-shutting-down-official-emurgo-recovery-update/155545) |
